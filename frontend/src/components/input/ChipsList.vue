...
function focusNext() {
  ...
  localFocusedItem.value = Math.min(props.modelValue.length - 1, localFocusedItem.value + 1)
}
</script>
...
<template>
  ...
  >
    <template v-if="modelValue">
      ...
      >
        <span
          class="ris-label3-regular inline overflow-hidden text-ellipsis whitespace-nowrap py-6 pl-8 text-18"
