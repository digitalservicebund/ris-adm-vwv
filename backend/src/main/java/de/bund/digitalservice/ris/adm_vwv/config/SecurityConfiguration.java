...
public class SecurityConfiguration {
  ...
  SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    ...
    /*
     * Security headers (CSP, X-Frame-Options, etc.) are disabled here because they are
     * managed directly in the Nginx configuration. The `add_header ... always;`
     * directive in Nginx overwrites any headers set by this application.
     */
    return http.build();
  }
